...
class _RegisterPageState extends State<RegisterPage>  {
  ...
  String user=""; String password=""; String phone ="";
  String email="";
  String location= "";
  String age ="";
  String sex="";
  ...
  Widget build(BuildContext context) {
      ...
      return Wrap (
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Text("Login", style: TextStyle(decoration: TextDecoration.none,
    ...
    Widget _userSelection(){
      return Wrap (
        ...
        spacing: 10.0,
        children: <Widget>[
          Text("I am a",  style: TextStyle(decoration: TextDecoration.none,
        color:  LightColor.black, fontWeight: FontWeight.bold,
        fontSize: 14, ),).vP8,
          ...
          GestureDetector(
            ...
            child: Text("General user", style: TextStyle(decoration: TextDecoration.none,
              color:  LightColor.themered, fontWeight: FontWeight.bold,
              fontSize: 14, )),
          ...
          GestureDetector(
            ...
            child: Text("Doctor", style: TextStyle(decoration: TextDecoration.none,
              color:  LightColor.iconColor, fontWeight: FontWeight.bold,
              fontSize: 14, )),
            ...
            Container(
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: SizedBox(
                      width: 55,
                      child: Icon(Icons.filter_vintage, color: LightColor.themered)
                          .alignCenter
                          .ripple(() {}, borderRadius: BorderRadius.circular(13))),
                ),
              ),
